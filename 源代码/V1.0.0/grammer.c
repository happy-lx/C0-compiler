...
ASTNODE* stmt()
{
    ...
    {
    case IF:
        result->childen[0] = condition_stmt();
        break;
    case DO:
        result->childen[0] = while_stmt();
        break;
    case FOR:
        result->childen[0] = for_stmt();
        break;
    case LBB:
        match(LBB);
        ...
        break;
    case PRINTF:
        result->childen[0] = printf_stmt();
        match(SEMI);
        break;
    case SCANF:
        result->childen[0] = scanf_stmt();
        match(SEMI);
        break;
    case RETURN:
        result->childen[0] = return_stmt();
        match(SEMI);
        break;
    case SEMI:
        match(SEMI);
    ...
    case ID:
        ...
        {
            result->childen[0] = assgin_stmt();//a = || a[
            match(SEMI);
        }else if(token == LB)
        {
            result->childen[0] = fun_call();//a(
            match(SEMI);
        }
    default:
        //错误处理，待完善
    ...
    switch(token)
    {
        ...
        case ID:
            ...
            }else
            {
                ...
                strcpy(result->attr.name,tokenvalue);
                return result;
            }
        case LB:
            match(LB);
